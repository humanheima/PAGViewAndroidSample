...
public class APIsDetailActivity extends AppCompatActivity {
    ...
    private void initPAGView() {
        ...
        pagView.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    void testReplaceImage(PAGFile pagFile, PAGView pagView) {
        if (pagFile == null || pagView == null || pagFile.numImages() <= 0) {
            return;
        }
    ...
    private PAGFile getPagFile(int row, int colume, String name, float itemWidth, float itemHeight) {
        ...
        Log.i(TAG, "getPagFile: name = " + name);
